...
export function AtlasDockCard({
  ...
  return (
    <button
      ...
      className={cn(
        'group relative block w-full min-w-0 appearance-none overflow-hidden rounded-[14px] border bg-[var(--atlas-card)] text-left shadow-[0_12px_36px_-28px_var(--atlas-shadow)] outline-none duration-200 [transition-property:transform,border-color,background-color,box-shadow] focus-visible:ring-2 focus-visible:ring-[var(--atlas-accent)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--atlas-bg)]',
        active
